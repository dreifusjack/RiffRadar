...
class RedisCache:
    ...
    def get_cached_query(self, chords: List[str], n_results: int) -> Optional[List[Dict]]:
    ...
    def set_cached_query(self, chords: List[str], n_results: int, results: List[Dict], ttl: Optional[int] = None):
        """Cache query results"""
        try:
            cache_key = self._generate_cache_key(chords, n_results)
